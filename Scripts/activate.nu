...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\magnu\Workspaces\PycharmProjects\Process_Mining'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\magnu\Workspaces\PycharmProjects\Process_Mining\Scripts\deactivate.nu'
